 ...
 *
 * Commandline:
 *    --api='gles2=2.0' --extensions='GL_OES_EGL_image,GL_OES_EGL_image_external' c
 *
 * Online:
 *    http://glad.sh/#api=gles2%3D2.0&extensions=GL_OES_EGL_image%2CGL_OES_EGL_image_external&generator=c&options=
 *
 */
